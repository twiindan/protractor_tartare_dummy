...
- [Feature: Create folder](#feature-create-folder)
  - [Scenario: Create a folder using contextual menu](#feature-create-folder-scenario-create-a-folder-using-contextual-menu)
  - [Scenario: Create a folder using "+" menu](#feature-create-folder-scenario-create-a-folder-using--menu)
  - [Scenario: Create a folder with case sensitive](#feature-create-folder-scenario-create-a-folder-with-case-sensitive)
  - [Scenario: Create a folder with existant name](#feature-create-folder-scenario-create-a-folder-with-existant-name)
  - [Scenario: Create folder with the default name](#feature-create-folder-scenario-create-folder-with-the-default-name)
  - [Scenario: Create folder with the default name when exist an element with the default name](#feature-create-folder-scenario-create-folder-with-the-default-name-when-exist-an-element-with-the-default-name)
  - [Scenario: Cancel the create folder action](#feature-create-folder-scenario-cancel-the-create-folder-action)
  - [Scenario: Create a folder with more than 200 charactares](#feature-create-folder-scenario-create-a-folder-with-more-than-200-charactares)
  - [Scenario: Rename a file with invalid characters](#feature-create-folder-scenario-rename-a-file-with-invalid-characters)
  - [Scenario: Rename a file with empty string](#feature-create-folder-scenario-rename-a-file-with-empty-string)
  - [Scenario: Rename a file with only spaces](#feature-create-folder-scenario-rename-a-file-with-only-spaces)
  - [Scenario: Automatic scrolling create folder](#feature-create-folder-scenario-automatic-scrolling-create-folder)
...
- [Feature: Rename elements](#feature-rename-elements)
  - [Scenario: Rename a file](#feature-rename-elements-scenario-rename-a-file)
  - [Scenario: Rename a file with case sensitive](#feature-rename-elements-scenario-rename-a-file-with-case-sensitive)
  - [Scenario: Rename a file with existant name](#feature-rename-elements-scenario-rename-a-file-with-existant-name)
  - [Scenario: Rename a file with existant name in a folder](#feature-rename-elements-scenario-rename-a-file-with-existant-name-in-a-folder)
  - [Scenario: Element name not change after rename without changes](#feature-rename-elements-scenario-element-name-not-change-after-rename-without-changes)
  - [Scenario: Cancel the element rename action](#feature-rename-elements-scenario-cancel-the-element-rename-action)
  - [Scenario: Rename a file with more than 200 charactares](#feature-rename-elements-scenario-rename-a-file-with-more-than-200-charactares)
  - [Scenario: Rename a file with invalid characters](#feature-rename-elements-scenario-rename-a-file-with-invalid-characters)
  - [Scenario: Rename a file with empty string](#feature-rename-elements-scenario-rename-a-file-with-empty-string)
  - [Scenario: Rename a file with only spaces](#feature-rename-elements-scenario-rename-a-file-with-only-spaces)
  - [Scenario: Automatic scrolling after rename](#feature-rename-elements-scenario-automatic-scrolling-after-rename)
